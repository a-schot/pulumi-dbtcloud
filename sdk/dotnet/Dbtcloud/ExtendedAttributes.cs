...
namespace ASchot.Pulumi.Dbtcloud
{
    ...
    ///     var myAttributes = new Dbtcloud.ExtendedAttributes("myAttributes", new()
    ///     {
    ...
    public partial class ExtendedAttributes : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ExtendedAttributes(string name, ExtendedAttributesArgs args, CustomResourceOptions? options = null)
            : base("dbtcloud:index/extendedAttributes:ExtendedAttributes", name, args ?? new ExtendedAttributesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExtendedAttributes(string name, Input<string> id, ExtendedAttributesState? state = null, CustomResourceOptions? options = null)
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ExtendedAttributes Get(string name, Input<string> id, ExtendedAttributesState? state = null, CustomResourceOptions? options = null)
        {
            return new ExtendedAttributes(name, id, state, options);
        }
    }

    public sealed class ExtendedAttributesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A JSON string listing the extended attributes mapping. The keys are the connections attributes available in the
        /// `profiles.yml` for a given adapter. Any fields entered will override connection details or credentials set on the
        ...
        public ExtendedAttributesArgs()
        {
        }
        public static new ExtendedAttributesArgs Empty => new ExtendedAttributesArgs();
    }

    public sealed class ExtendedAttributesState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A JSON string listing the extended attributes mapping. The keys are the connections attributes available in the
        /// `profiles.yml` for a given adapter. Any fields entered will override connection details or credentials set on the
        ...
        public ExtendedAttributesState()
        {
        }
        public static new ExtendedAttributesState Empty => new ExtendedAttributesState();
    }
}
