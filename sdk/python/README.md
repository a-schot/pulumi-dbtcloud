...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `dbtcloud` with the `NAME` of your provider.
...
- binary: pulumi-resource-dbtcloud
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-dbtcloud/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-dbtcloud_darwin_amd64_v1
│   └── pulumi-resource-dbtcloud
├── pulumi-dbtcloud_darwin_arm64
│   └── pulumi-resource-dbtcloud
├── pulumi-dbtcloud_linux_amd64_v1
│   └── pulumi-resource-dbtcloud
├── pulumi-dbtcloud_linux_arm64
│   └── pulumi-resource-dbtcloud
├── pulumi-dbtcloud_windows_amd64_v1
│   └── pulumi-resource-dbtcloud.exe
└── pulumi-dbtcloud_windows_arm64
    └── pulumi-resource-dbtcloud.exe
```
