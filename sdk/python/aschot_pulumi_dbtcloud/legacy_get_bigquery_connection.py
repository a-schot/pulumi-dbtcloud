...
__all__ = [
    ...
    'legacy_get_bigquery_connection',
    'legacy_get_bigquery_connection_output',
]
...
def legacy_get_bigquery_connection(connection_id: Optional[int] = None,
...
@_utilities.lift_output_func(legacy_get_bigquery_connection)
def legacy_get_bigquery_connection_output(connection_id: Optional[pulumi.Input[int]] = None,
