...
__all__ = [
    'LegacyGetPostgresCredentialResult',
    'AwaitableLegacyGetPostgresCredentialResult',
    'legacy_get_postgres_credential',
    'legacy_get_postgres_credential_output',
]
...
@pulumi.output_type
class LegacyGetPostgresCredentialResult:
    """
...
class AwaitableLegacyGetPostgresCredentialResult(LegacyGetPostgresCredentialResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return LegacyGetPostgresCredentialResult(
...
def legacy_get_postgres_credential(credential_id: Optional[int] = None,
                                   project_id: Optional[int] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableLegacyGetPostgresCredentialResult:
    """
    Use this data source to access information about an existing resource.
    """
    pulumi.log.warn("""legacy_get_postgres_credential is deprecated: Do not use! This resource is mapped from the legacy Terraform `dbt_cloud_`-prefixed resource/datasource""")
    __args__ = dict()
    __args__['credentialId'] = credential_id
    __args__['projectId'] = project_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('dbtcloud:index/legacyGetPostgresCredential:LegacyGetPostgresCredential', __args__, opts=opts, typ=LegacyGetPostgresCredentialResult).value

    return AwaitableLegacyGetPostgresCredentialResult(
...
@_utilities.lift_output_func(legacy_get_postgres_credential)
def legacy_get_postgres_credential_output(credential_id: Optional[pulumi.Input[int]] = None,
                                          project_id: Optional[pulumi.Input[int]] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[LegacyGetPostgresCredentialResult]:
    """
    Use this data source to access information about an existing resource.
    """
    pulumi.log.warn("""legacy_get_postgres_credential is deprecated: Do not use! This resource is mapped from the legacy Terraform `dbt_cloud_`-prefixed resource/datasource""")
