...
__all__ = ['LegacyEnvironmentVariableArgs', 'LegacyEnvironmentVariable']

@pulumi.input_type
class LegacyEnvironmentVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, Any]] environment_values: Map from environment names to respective variable value, a special key `project` should be set for the project default
...
@pulumi.input_type
class _LegacyEnvironmentVariableState:
    def __init__(__self__, *,
...
class LegacyEnvironmentVariable(pulumi.CustomResource):
    warnings.warn("""Do not use! This resource is mapped from the legacy Terraform `dbt_cloud_`-prefixed resource/datasource""", DeprecationWarning)
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LegacyEnvironmentVariable resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LegacyEnvironmentVariableArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a LegacyEnvironmentVariable resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param LegacyEnvironmentVariableArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LegacyEnvironmentVariableArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LegacyEnvironmentVariableArgs.__new__(LegacyEnvironmentVariableArgs)
        ...
        super(LegacyEnvironmentVariable, __self__).__init__(
            'dbtcloud:index/legacyEnvironmentVariable:LegacyEnvironmentVariable',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            environment_values: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            project_id: Optional[pulumi.Input[int]] = None) -> 'LegacyEnvironmentVariable':
        """
        ...
        __props__ = _LegacyEnvironmentVariableState.__new__(_LegacyEnvironmentVariableState)

        __props__.__dict__["environment_values"] = environment_values
        __props__.__dict__["name"] = name
        __props__.__dict__["project_id"] = project_id
        return LegacyEnvironmentVariable(resource_name, opts=opts, __props__=__props__)
