...
__all__ = [
    ...
    'get_bigquery_connection_output',
]
...
def get_bigquery_connection(connection_id: Optional[int] = None,
...
@_utilities.lift_output_func(get_bigquery_connection)
def get_bigquery_connection_output(connection_id: Optional[pulumi.Input[int]] = None,
