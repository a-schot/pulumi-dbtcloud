...
export class LegacyWebhook extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LegacyWebhookState, opts?: pulumi.CustomResourceOptions): LegacyWebhook {
        return new LegacyWebhook(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dbtcloud:index/legacyWebhook:LegacyWebhook';

    /**
     * Returns true if the given object is an instance of LegacyWebhook.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LegacyWebhook {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LegacyWebhook.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LegacyWebhookArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LegacyWebhookArgs | LegacyWebhookState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LegacyWebhookState | undefined;
            ...
            const args = argsOrState as LegacyWebhookArgs | undefined;
        ...
        super(LegacyWebhook.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LegacyWebhookState {
    /**
     * Webhooks Account Identifier
     */
 ...
 */
export interface LegacyWebhookArgs {
    /**
     * Webhooks active flag
     */
    active?: pulumi.Input<boolean>;
