...
export class LegacySnowflakeCredential extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LegacySnowflakeCredentialState, opts?: pulumi.CustomResourceOptions): LegacySnowflakeCredential {
        pulumi.log.warn("LegacySnowflakeCredential is deprecated: Do not use! This resource is mapped from the legacy Terraform `dbt_cloud_`-prefixed resource/datasource")
