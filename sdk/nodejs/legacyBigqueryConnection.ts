 ...
 */
export class LegacyBigqueryConnection extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LegacyBigqueryConnectionState, opts?: pulumi.CustomResourceOptions): LegacyBigqueryConnection {
        pulumi.log.warn("LegacyBigqueryConnection is deprecated: Do not use! This resource is mapped from the legacy Terraform `dbt_cloud_`-prefixed resource/datasource")
        return new LegacyBigqueryConnection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dbtcloud:index/legacyBigqueryConnection:LegacyBigqueryConnection';

    /**
     * Returns true if the given object is an instance of LegacyBigqueryConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LegacyBigqueryConnection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LegacyBigqueryConnection.__pulumiType;
    }
     ...
     */
    /** @deprecated Do not use! This resource is mapped from the legacy Terraform `dbt_cloud_`-prefixed resource/datasource */
    constructor(name: string, args: LegacyBigqueryConnectionArgs, opts?: pulumi.CustomResourceOptions)
    /** @deprecated Do not use! This resource is mapped from the legacy Terraform `dbt_cloud_`-prefixed resource/datasource */
    constructor(name: string, argsOrState?: LegacyBigqueryConnectionArgs | LegacyBigqueryConnectionState, opts?: pulumi.CustomResourceOptions) {
        pulumi.log.warn("LegacyBigqueryConnection is deprecated: Do not use! This resource is mapped from the legacy Terraform `dbt_cloud_`-prefixed resource/datasource")
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LegacyBigqueryConnectionState | undefined;
            ...
            const args = argsOrState as LegacyBigqueryConnectionArgs | undefined;
        ...
        super(LegacyBigqueryConnection.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LegacyBigqueryConnectionState {
    /**
     * The Application ID for BQ OAuth
     */
 ...
 */
export interface LegacyBigqueryConnectionArgs {
    /**
     * The Application ID for BQ OAuth
     */
    applicationId?: pulumi.Input<string>;
